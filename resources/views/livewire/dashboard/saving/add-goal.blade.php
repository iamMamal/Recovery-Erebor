    ...
    <div class="app-ecommerce">
        ...
        <div
            ...
            <div class="d-flex flex-column justify-content-center">
                <h4 class="mb-1 mt-3">یک هدف جدید اضافه کنید</h4>
                <p class="text-muted">شما تنها یک هدف می توانید بسازید و در صورت ساختن می توانید آن را به دلخواه ویرایش یا حذف کنید در صورت حذف تراکنش های پس انداز از بین میروند ولی در ویرایش ثابت می مانند</p>
            </div>
                ...
                <form wire:submit.prevent="save" class="mb-3">
                    <div class="card mb-4">
                        <div class="card-header">
                            <h5 class="card-tile mb-0">اطلاعات هدف پس انداز</h5>
                        </div>
                        <div class="card-body">
                            ...
                            >
                                <label class="form-label">مبلغ هدف پس انداز</label>
                                <input   @input="balance = formatNumber($event.target.value)"
                                         @blur="@this.set('balance', balance.replace(/,/g, ''))"
                                         x-model="balance"  wire:model.live="balance" class="form-control"
                                         placeholder=" مبلغ هدف" type="text"
                                         style="background-color: unset">
                                <p class="mt-2 text-green-400">مبلغ وارد شده: <span x-text="resultText"></span> تومان</p>
                                <x-input-error :messages="$errors->get('balance')" class="mt-2"/>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">نام هدف پس انداز</label>
                                <input wire:model="title" class="form-control" placeholder="خرید گوشی..."
                    ...
                    <div class="col-md-6 col-12 mb-4 mx-auto parent">
                        <label class="form-label" >انتخاب تاریخ برای هدف</label>
                    ...
                    <div class="d-flex align-content-center flex-wrap gap-3">
                        <button  type="submit" wire:loading.attr='disabled'
                                 class="btn btn-primary waves-effect waves-light">{{ $savingId ? 'ویرایش' : 'ایجاد' }}
                        </button>
                        <div
                            class="d-flex gap-3">
