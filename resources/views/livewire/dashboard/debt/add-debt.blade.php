                ...
                <form wire:submit.prevent="save" class="mb-3">
                    <div class="card mb-4">
                        <div class="card-header">
                            <h5 class="card-tile mb-0 text-xl">ثبت بدهی یا طلب</h5>
                            <p class="text-base">شما در این قسمت ابتدا دلیل طلب یا بدهی را می سازید و برای قسط بندی از قسمت افزودن تعداد قسط باید ادامه دهید</p>
                        </div>
                        <div class="card-body">
                            ...
                            >
                                <label class="form-label">مبلغ کل اقساط یا طلب</label>
                                <input
                                    ...
                                    class="form-control"
                                    placeholder="مبلغ مجموع اقساط" type="text"
                            ...
                            <div class="mb-3">
                                ...
                                <input wire:model="title" class="form-control" placeholder="عنوان بدهی/طلب "
                        ...
                        <div class="col">
                            <div class="card">
                                <h5 class="card-header">انتخاب نوع طلب یا بدهی</h5>
                                <div class="card-body">
                                    <div class="row">
                                            ...
                                            <div class="form-check custom-option custom-option-icon {{ $selectedOption === 'option2' ? 'checked' : '' }}"
                                                ...
                                                <label class="form-check-label custom-option-content " for="customRadioVarizi" >
                                                    <span class="custom-option-body">
                                                        ...
                                                        <span class="custom-option-title">ورودی به حساب(طلب)</span>
                                                    </span>
                                        ...
                                        <div class="col-md-2 mb-md-0 mb-2">
                                            <div class="form-check custom-option custom-option-icon {{ $selectedOption === 'option1' ? 'checked' : '' }}"
                                                ...
                                                <label class="form-check-label custom-option-content" for="customRadioBardasht" >
                                                    <span class="custom-option-body">
                                                        <i class="las la-credit-card"></i>
                                                        <span class="custom-option-title">برداشت از حساب(بدهی)</span>
                                                    </span>
